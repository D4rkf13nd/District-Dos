          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-8">
              <div class="top-controls">
                ...
                <label for="importInput" class="btn btn-blue btn-custom" tabindex="0" aria-label="Import CSV">
                  <i class="fas fa-upload"></i> Import CSV
                </label>
                <input type="file" id="importInput" accept=".csv" style="display: none;" onchange="handleImportCSV(event)" aria-label="Choose CSV file" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-lg-4">
              <div class="page-header">
                <h2>Calendar</h2>
                <p>View and manage your events and schedules.</p>
              </div>
            </div>
            <div class="col-lg-8">
              <div class="top-controls">
